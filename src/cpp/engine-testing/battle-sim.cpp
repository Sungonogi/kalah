#include "./board/board-position.cpp"
#include "./engine-versions/min-max-nab.cpp"
#include "./engine-versions/min-max-ab.cpp"
#include "./engine-versions/min-max-ab-s2.cpp"
#include "./engine-versions/min-max-ab-s2-do.cpp"
#include "./engine-versions/min-max-ab-s2-ge.cpp"
#include "./engine-versions/min-max-ab-s2-ec.cpp"
#include "./engine-versions/min-max-ab-s3-ec.cpp"
#include "./engine-versions/min-max-ab-s2-ec-o2.cpp"
#include "./engine-versions/min-max-ab-s2-ec-o2bug.cpp"
#include "./engine-versions/min-max-ab-s2-ec-o3.cpp"
#include "./engine-versions/min-max-ab-s2-ec-o4.cpp"
#include "./engine-versions/min-max-ab-s2-ec-o2-dc.cpp"
#include "./engine-versions/min-max-ab-s2-ec-o2-h.cpp"
#include "./engine-versions/min-max-ab-s4-ec-o2-h.cpp"
#include "./engine-versions/min-max-ab-s5-ec-o2-h.cpp"
